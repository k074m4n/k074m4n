...
<img src="https://kotaman.net/gh/stack.png" alt="Focus: AI and LLM security, IoT security, WiFi security, hardware and RF. Notes: the risk starts when a model gets tools, not when it gets bigger; the cleanest way in is not a wiretap, it is a receipt; you are the product being logged, bought and resold." width="100%">
